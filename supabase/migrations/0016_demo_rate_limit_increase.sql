-- Aumenta limite de demo por IP: 3 → 10 por dia
-- Aumenta limite global diário: 100 → 200 sessões
-- Motivo: limite anterior era muito restritivo para uso em portfólio/demonstração.
-- Reason: previous limit was too tight for portfolio/showcase usage.
